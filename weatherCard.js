...
import './WeatherCard.css'; // Kart bileşeninin kendi CSS dosyası olacak

// Hava durumu açıklamalarını simge URL'leri ile eşleyen bir obje
...
function WeatherCard({ forecast }) {
  return (
    <div className="weather-card">
      ...
      <p>Sıcaklık: {forecast.temperatureC}°C / {forecast.temperatureF}°F</p>
